# Ren Florist Clone — Next.js

Website phong cách Ren Florist xây dựng bằng Next.js 14.
...
│   ├── WhySection.js     ← Vì sao Ren được yêu thích
│   └── Footer.js         ← Footer
├── public/
