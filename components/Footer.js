...
const defaultStores = [
  ...
  { address: '160B Võ Thị Sáu, phường Xuân Hoà, HCM', mapUrl: 'https://maps.google.com' },
]
      ...
      <div className={styles.grid}>
        <div className={styles.left}>
          ...
          <div className={styles.stores}>
            {stores.map((store, i) => (
              <a key={i} href={store.mapUrl || 'https://maps.google.com'} target="_blank" rel="noopener noreferrer">
                {store.address}
              </a>
            ))}
          </div>
        ...
        <div className={styles.links}>
          <Link href="/ve-akina-florist">VỀ {siteName}</Link>
